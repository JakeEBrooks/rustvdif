...
/// Allows the generation of VDIF frames.
pub struct VDIFSim {
    frame_size: u32,
    frame_rate: usize,
    thread_no: usize,
...
impl VDIFSim {
    ...
    pub fn new(frame_size: usize, frame_rate: usize, thread_no: usize) -> Self {
        return Self { frame_size: frame_size as u32, frame_rate: frame_rate, thread_no: thread_no, current_frame: 0, current_thread: 0, current_time: 0 }
    }
    ...
    /// ```
    /// 
    /// All data samples are set to zero, and `self.current_` variables are handled when this function is called.
